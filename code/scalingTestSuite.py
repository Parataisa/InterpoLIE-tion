...
def run_scaling_test(input_folder, scaling_factors=None, interpolation_methods=None, sensitivity='medium', output_folder=None, detector_class=None, create_visualizations=True, downscale_size=512, downscale=True, crop_center=False, max_gradient=None):
    test_suite = ScalingTestSuite(scaling_factors=scaling_factors, interpolation_methods=interpolation_methods, crop_center=crop_center, max_gradient=max_gradient)
